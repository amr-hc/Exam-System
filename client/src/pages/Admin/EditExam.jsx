        ...
        <div>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group as={Row} controlId="formExamDuration">
                    ...
                    <Col sm={10}>
                        <Form.Control type="time" name="duration" value={exam.duration} onChange={handleChange} />
                    </Col>
                </Form.Group>
                ...
                <Button variant="primary" onClick={() => setNewQuestionVisible(!newQuestionVisible)}>
                    {newQuestionVisible ? 'Hide Add Question Form' : 'Add New Question'}
                </Button>
                {newQuestionVisible && (
                    <div>
                        <Form.Group as={Row} controlId="formNewQuestion">
                            <Form.Label column sm={2}>New Question</Form.Label>
                            <Col sm={10}>
                                <Form.Control type="text" name="question" value={newQuestion.question} onChange={handleNewQuestionChange} />
                            </Col>
                        </Form.Group>
                        <Form.Group as={Row} controlId="formNewQuestionDegree">
                            <Form.Label column sm={2}>Degree</Form.Label>
                            <Col sm={10}>
                                <Form.Control type="number" name="degree" value={newQuestion.degree} onChange={handleNewQuestionChange} />
                            </Col>
                        </Form.Group>
                ...
                <Button variant="success" type="submit">Update Exam</Button>
            </Form>
        </div>
    );
};
